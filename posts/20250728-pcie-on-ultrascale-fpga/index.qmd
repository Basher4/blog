...
![Aliexpress Kintex UltraScale+ board](imgs/aliexpress_ku5p.jpg)
...
![XDMA IP Configured in AXI Bridge Mode](imgs/xdma-axi-bridge-mode.png)

With this configuration the IP will translate reads and writes to BAR0 of the PCIe device as AXI4 reads and writes.

![XDMA IP BAR0 to AXI offset translateion](imgs/xdma-axi-bridge-pcie-to-axi-translate.png)
...
![ILA Capture of READ transactions](imgs/vivado-read-transaction.png)
...
![ILA Capture of WRITE transactions](imgs/vivado-write-transactions.png)
