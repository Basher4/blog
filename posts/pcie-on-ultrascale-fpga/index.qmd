---
title: "PCIe on UltraScale+ FPGA: Hello World"
description: "Building a basic PCIe-to-AXI bridge on a Xilinx UltraScale+ FPGA, accessing BAR0 through VFIO, and benchmarking MMIO performance."
author: "Matej Genci"
date: "2025-07-28"
...
categories:
  ...
  - vfio
  - rust
source: "https://github.com/Basher4/xilinx-pcie-basics/blob/master/STORY.md"
repo: "https://github.com/Basher4/xilinx-pcie-basics"
commit: "8acaf305f5e6a9ef21f1518cc4499d376518c6b3"
title-meta-links:
  - label: "Repository"
    text: "xilinx-pcie-basics"
    icon: "github"
    href: "https://github.com/Basher4/xilinx-pcie-basics/tree/master"
---

```{=html}
<script type="application/json" id="title-meta-links">
[
  {
    "label": "Repository",
    "text": "xilinx-pcie-basics",
...
<script>
(() => {
  const metaLinks = document.getElementById("title-meta-links");
  const titleMeta = document.querySelector(".quarto-title-meta");

  if (!metaLinks || !titleMeta) {
    return;
  }

  for (const link of JSON.parse(metaLinks.textContent)) {
    const wrapper = document.createElement("div");
    wrapper.innerHTML = `
      <div class="quarto-title-meta-heading"></div>
      <div class="quarto-title-meta-contents"></div>
    `;

    wrapper.querySelector(".quarto-title-meta-heading").textContent = link.label;
    ...
    wrapper.querySelector(".quarto-title-meta-contents").append(paragraph);

    titleMeta.append(wrapper);
  }
})();
</script>
```
...
![Aliexpress Kintex UltraScale+ board](https://raw.githubusercontent.com/Basher4/xilinx-pcie-basics/master/docs/imgs/aliexpress_ku5p.jpg)
...
![XDMA IP Configured in AXI Bridge Mode](https://raw.githubusercontent.com/Basher4/xilinx-pcie-basics/master/docs/imgs/xdma-axi-bridge-mode.png)

With this configuration the IP will translate reads and writes to BAR0 of the PCIe device as AXI4 reads and writes.

![XDMA IP BAR0 to AXI offset translateion](https://raw.githubusercontent.com/Basher4/xilinx-pcie-basics/master/docs/imgs/xdma-axi-bridge-pcie-to-axi-translate.png)
...
![Block Diagram](https://raw.githubusercontent.com/Basher4/xilinx-pcie-basics/master/docs/imgs/block.svg)
...
If you're curious about how that went down, have a look at the [./sw/ai-generated](https://github.com/Basher4/xilinx-pcie-basics/tree/master/sw/ai-generated) directory.
...
do. For example, the [`setup_vfio.py`](https://github.com/Basher4/xilinx-pcie-basics/blob/master/sw/ai-generated/setup_vfio.py) script was generated by AI and it works well
...
The result is the [vfio-benchmark](https://github.com/Basher4/xilinx-pcie-basics/tree/master/sw/vfio-benchmark) project. It uses the
...
Let's go back to basics and write the benchmark in C: [vfio_test.c](https://github.com/Basher4/xilinx-pcie-basics/blob/master/sw/vfio_test.c).
...
![ILA Capture of READ transactions](https://raw.githubusercontent.com/Basher4/xilinx-pcie-basics/master/docs/imgs/vivado-read-transaction.png)
...
![ILA Capture of WRITE transactions](https://raw.githubusercontent.com/Basher4/xilinx-pcie-basics/master/docs/imgs/vivado-write-transactions.png)
